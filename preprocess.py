...
VP -> VB NP PP | VB VBD PP | VB IN JJ | VB IN CD | VB PRP IN | MD VP | VB JJ | VP CC VP | VB | VP CC NP | VB S | VB CC VB PP SBAR | VBN | VBZ VP | MD VP | VB NP | VB S | TO VP | VB COMMA VP | VBD S | VP ADVP
NP -> DT NNS | DT NN | NN | NNS | DT NNS PP | JJ NN | JJ NNS | CD NNS | PRP | NP PP | PDT DT NNS | NP CC NP| DT JJ NN NN | JJR NN | CD NN
PP -> IN NP | JJ IN NP
SBAR -> IN S | WRB S
ADJP -> JJ
ADVP -> RB
