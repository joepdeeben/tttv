...
S -> VP | DT NP VP | DT NP VP CC VP
VP -> VB | VB NP | VB NP PP | VB PP | VB ADJP | VBP | VBD | VBZ
NP -> NN | DT NN | CD NN | JJ NN | JJ NNS | NNS | PRP | NNP | PRPS NN | NNP NN | DT NNS
PP -> IN NP
ADJP -> JJ | JJ CC JJ 
...
NNS -> 'cheese' | 'beans'| 'hours'| 'ingredients'| 'carrots'| 'parsnips'| 'minutes'| 'cubes'| 'onions'| 'tomatoes'| 'khoya'| 'balls'| 'cups'| 'sides'| 'crystals'| 'mintures'| 'slices'| 'spoons'| 'boils'| 'cloth'| 'nuts'| 'cristals'| 'flavour'| 'pools'| 'seeds'| 'times'| 'pieces'| 'almonds'| 'pistachios'| 'yolks'| 'fingers'| 'tbsp'| 'layers'| 'mins'| 'batches'
